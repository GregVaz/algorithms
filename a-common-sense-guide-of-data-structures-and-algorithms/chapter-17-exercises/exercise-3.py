...
class Trie:
    ...
    def traverse_and_print(self, prefix=''):
        currentNode = self.search(prefix)
        if not currentNode:
            return None
        return self.collectAllWords(currentNode, word=prefix, words=[])


autocomplete = Trie()
autocomplete.insertion('tag')
autocomplete.insertion('tan')
autocomplete.insertion('tank')
autocomplete.insertion('tap')
autocomplete.insertion('today')
autocomplete.insertion('total')
autocomplete.insertion('well')
autocomplete.insertion('went')

# print('Autocomplete \'ta\' prefix: ' +
#       str(autocomplete.autocomplete('ta')))

print('Traverse all words on trie: ' +
      str(autocomplete.traverse_and_print()))
print('Traverse words that start with \'t\' on trie: ' +
      str(autocomplete.traverse_and_print('t')))
print('Traverse words that start with \'w\' on trie: ' +
      str(autocomplete.traverse_and_print('w')))
